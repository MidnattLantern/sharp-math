...
class UIApp
{
    public void WriteMainMenu()
    {
        ...
        Console.WriteLine($" 3: Calculate Slope");
        Console.WriteLine($" 4: Reveal X Coordinates");
        Console.WriteLine($" 5: Reveal Y Coordinates");
        DryHeader();
    }

    public void WriteUnknownPrompt(string? prompt) // optional
    {
